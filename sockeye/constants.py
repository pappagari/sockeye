...
SCHEDULED_SAMPLING_FULL = 'full'
SCHEDULED_SAMPLING_UNIFORM = 'uniform'
SCHEDULED_SAMPLING_FAST = 'fast'
SCHEDULED_SAMPLING_DIFF = 'diff'
SCHEDULED_SAMPLING_CHOICES = [SCHEDULED_SAMPLING_FULL, SCHEDULED_SAMPLING_UNIFORM, SCHEDULED_SAMPLING_FAST,
                              SCHEDULED_SAMPLING_DIFF]
