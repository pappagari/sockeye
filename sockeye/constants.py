...
FEED_FORWARD_COMPRESS_INITIALIZE_REINIT = 'reinit'
FEED_FORWARD_COMPRESS_INITIALIZE_FIRST = 'first'
FEED_FORWARD_COMPRESS_INITIALIZE_MAX = 'max'
FEED_FORWARD_COMPRESS_INITIALIZE_CHOICES = [FEED_FORWARD_COMPRESS_INITIALIZE_REINIT,
                                            FEED_FORWARD_COMPRESS_INITIALIZE_FIRST,
                                            FEED_FORWARD_COMPRESS_INITIALIZE_MAX]
