...
@pytest.mark.parametrize("test_params, expected_params", [
    ('', dict(batch_size=4096,
              ...
              scheduled_sampling_rate=1,
              scheduled_sampling_rate_warmup=0,
              scheduled_sampling_temperature=1,
              scheduled_sampling_temperature_warmup=0,
              scheduled_sampling_sample=False,
              length_task=None,
